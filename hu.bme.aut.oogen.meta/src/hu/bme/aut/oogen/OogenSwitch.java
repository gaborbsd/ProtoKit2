...
public class OogenSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case OogenPackage.OO_PRINT: {
				OOPrint ooPrint = (OOPrint)theEObject;
				T result = caseOOPrint(ooPrint);
				if (result == null) result = caseOOStatement(ooPrint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case OogenPackage.OO_WRITE_FILE: {
				OOWriteFile ooWriteFile = (OOWriteFile)theEObject;
				T result = caseOOWriteFile(ooWriteFile);
				if (result == null) result = caseOOStatement(ooWriteFile);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>OO Print</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>OO Print</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOOPrint(OOPrint object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>OO Write File</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>OO Write File</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseOOWriteFile(OOWriteFile object) {
		return null;
	}
